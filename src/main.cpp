...
//
// $Id: main.cpp 13 2008-04-18 08:02:14Z eg1981 $
...
static void version() {
    cout << "ncwm - no cheese window manager - " << __NCWM_VERSION
...
static MSettings *initCommonSettings() {
    ...
    (*commonSettings)["terminal"] = "xterm -rv -e";
...
static MSettings *initActionSettings() {
    ...
    (*actionSettings)["extern.xterm.cmd"] = "xterm -rv";
...
int main(int argc, char *argv[])
{
    ...
    loadSettings(sessionSettings, "ncwm.session", home, false, true);
