...
//
// $Id: monitor.cpp 13 2008-04-18 08:02:14Z eg1981 $
...
void Monitor::updateBars() {
    ...
    if (XCORE->textProperty(rootWindow_, Atoms::NCWM_STATUSTEXT, &value)) {
        statusBar_->setText(value);
    }
    if (XCORE->textProperty(rootWindow_, Atoms::NCWM_METERTEXT, &value)) {
